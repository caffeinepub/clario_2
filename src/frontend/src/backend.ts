...
export class Backend implements backendInterface {
    ...
    async clearSubmissions(): Promise<string> {
    ...
    async submitForm(arg0: Submission): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitForm(to_candid_Submission_n5(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        suggestions: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.suggestions)),
        improvementGoal: value.improvementGoal,
        email: value.email,
        biggestProblem: value.biggestProblem,
        wouldUse: value.wouldUse
    };
}
...
function to_candid_Submission_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Submission): _Submission {
...
function to_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        suggestions: value.suggestions ? candid_some(value.suggestions) : candid_none(),
        improvementGoal: value.improvementGoal,
        email: value.email,
        biggestProblem: value.biggestProblem,
        wouldUse: value.wouldUse
