...
export class Backend implements backendInterface {
    ...
    async clearSignups(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.clearSignups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSignup(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSignup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
